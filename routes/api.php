...
Route::middleware(['auth:sanctum', 'type.admin'])->group(function () {
    ...
    Route::get('/admins/transaction/show', [TransactionController::class, 'index']);
    Route::get('/admins/transaction/show/{id}', [TransactionController::class, 'show']);
    Route::delete('/admins/transaction/delete/{id}', [TransactionController::class, 'destroy']);
});